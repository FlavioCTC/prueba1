...
document.getElementById("siguienteTrivia").addEventListener("click", () => { loadQuestions() });

/*
function prepararCafe(azucar,aguaCaliente,aguaFria,taza,leche){
    taza=azucar+aguaCaliente+......
    leche=false
}
*/
